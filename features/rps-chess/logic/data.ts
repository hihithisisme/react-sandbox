...
export interface IGameSettings {
    ...
    playerIdToDisplayColor: Map<string, string>;
}
...
export class Piece {
    ...
    static buildInitialScissorDice(id: string, playerId: string) {
        return new Piece(
            id,
            playerId,
            DiceFace.SCISSOR,
    ...
    static buildInitialRockDice(id: string, playerId: string) {
        return new Piece(
            id,
            playerId,
            DiceFace.ROCK,
    ...
    static buildInitialPaperDice(id: string, playerId: string) {
        return new Piece(
            id,
            playerId,
            DiceFace.PAPER,
